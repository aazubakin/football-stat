  ...
  <div>
    ...
    <div v-if="!isError">
      <h1 class="text-2xl font-bold">
        Список матчей команды: "{{ teamName }}"
      </h1>
      <div class="container p-10 mx-auto">
        <div>
          <div class="flex items-center flex-wrap justify-center">
            <span class="block text-left mb-4 mr-4"
              >Количество матчей команды: {{ count }}</span
            >
      ...
      <div class="min-h-screen bg-green-100 py-5 text-left">
...
export default {
  ...
  methods: {
    getMatches() {
      ...
      apiClient
        .getStat(API.teams.teamMatches(teamId), params)
        .then((response) => {
